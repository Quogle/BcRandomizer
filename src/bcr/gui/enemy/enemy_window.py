...
class EnemyWindow(QWidget):
    def __init__(self, config):
        ...
        trait_gimmicks_layout.addWidget(TraitGimmicks(self.config))
        ...
        force_traits = QGroupBox("Force Traits")
        force_traits_layout = QVBoxLayout(force_traits)

        force_traits_layout.addWidget(
            QLabel("Force trait settings will go here.")
        )

        content_layout.addWidget(force_traits)
