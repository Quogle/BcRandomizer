...
def balaluga(stats:list[list[list]]):
    ...
    balaluga_anim = gf.file_reader(balaluga_anim_name,vanilla=True,debug=False)#Im assuming its fine to pull the vanilla version of the animations since this is early on
