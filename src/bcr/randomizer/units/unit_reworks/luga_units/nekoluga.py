...
def nekoluga(stats:list[list[list]]):
    ...
    nekoluga_anim = gf.file_reader(nekoluga_anim_name,vanilla=True,debug=False) #Im assuming its fine to pull the vanilla version of the animations since this is early on
