...
def maiden(stats:list[list[list]]):
    ...
    (unit[0][c.s.hp],unit[1][c.s.hp],unit[2][c.s.hp]) = (1800,1800,2800) #was (994,994,1988)
    (unit[0][c.s.attack],unit[1][c.s.attack],unit[2][c.s.attack]) = (500,500,600) #was (277,277,277)
